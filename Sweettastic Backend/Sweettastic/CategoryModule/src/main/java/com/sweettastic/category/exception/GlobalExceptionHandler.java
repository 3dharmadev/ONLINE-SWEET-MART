package com.sweettastic.category.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> productException(CategoryException ce, WebRequest req){
		
		ErrorDetails error = new ErrorDetails(LocalDateTime.now(), ce.getMessage(), req.getDescription(false));
